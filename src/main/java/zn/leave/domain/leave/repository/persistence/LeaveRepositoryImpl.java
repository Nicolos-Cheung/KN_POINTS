package zn.leave.domain.leave.repository.persistence;

import zn.leave.domain.leave.repository.facade.LeaveRepositoryInterface;
import zn.leave.domain.leave.repository.mapper.ApprovalInfoDao;
import zn.leave.domain.leave.repository.mapper.LeaveDao;
import zn.leave.domain.leave.repository.mapper.LeaveEventDao;
import zn.leave.domain.leave.repository.po.ApprovalInfoPO;
